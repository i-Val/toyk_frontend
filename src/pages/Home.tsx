    ...
    return (
        <div>
            ...
            <div style={{ 
                ...
                <h1 style={{ fontSize: '3em', marginBottom: '20px' }}>Welcome to Toyk Market</h1>
                <p style={{ fontSize: '1.2em', marginBottom: '30px' }}>Buy and sell everything from cars to mobile phones.</p>
